...
typedef struct {
    ...
    bool overlay;
    i32 order;
} Mel_Render_Default_3D_View_Opt;
...
typedef struct {
    ...
    u32 composition_mode;
    const Mel_Alloc* alloc;
} Mel_Render_Default_3D_Widget_Layer_Opt;
...
typedef struct {
    ...
    f32 input_scale_y;
    const Mel_Alloc* alloc;
} Mel_Render_Default_3D_Widget_Layer;

bool mel_render_default_3d_init_opt(Mel_Render_Default_3D* renderer, Mel_Render_Default_3D_Opt opt);
#define mel_render_default_3d_init(renderer, ...) mel_render_default_3d_init_opt((renderer), (Mel_Render_Default_3D_Opt){__VA_ARGS__})
...
#define mel_render_default_3d_add_view(renderer, ...) mel_render_default_3d_add_view_opt((renderer), (Mel_Render_Default_3D_View_Opt){__VA_ARGS__})
...
#define mel_render_default_3d_widget_layer_init(renderer, layer, ...) mel_render_default_3d_widget_layer_init_opt((renderer), (layer), (Mel_Render_Default_3D_Widget_Layer_Opt){__VA_ARGS__})
