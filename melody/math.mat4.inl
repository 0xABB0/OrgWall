...
static inline Mel_Mat4 mel_mat4_inverse(Mel_Mat4 m)
{
    f32 a00 = m.m[0][0], a01 = m.m[0][1], a02 = m.m[0][2], a03 = m.m[0][3];
    f32 a10 = m.m[1][0], a11 = m.m[1][1], a12 = m.m[1][2], a13 = m.m[1][3];
    f32 a20 = m.m[2][0], a21 = m.m[2][1], a22 = m.m[2][2], a23 = m.m[2][3];
    f32 a30 = m.m[3][0], a31 = m.m[3][1], a32 = m.m[3][2], a33 = m.m[3][3];
    ...
    Mel_Mat4 r;
    r.m[0][0] = ( a11 * b11 - a12 * b10 + a13 * b09) * inv_det;
    r.m[0][1] = (-a01 * b11 + a02 * b10 - a03 * b09) * inv_det;
    r.m[0][2] = ( a31 * b05 - a32 * b04 + a33 * b03) * inv_det;
    r.m[0][3] = (-a21 * b05 + a22 * b04 - a23 * b03) * inv_det;
    r.m[1][0] = (-a10 * b11 + a12 * b08 - a13 * b07) * inv_det;
    r.m[1][1] = ( a00 * b11 - a02 * b08 + a03 * b07) * inv_det;
    r.m[1][2] = (-a30 * b05 + a32 * b02 - a33 * b01) * inv_det;
    r.m[1][3] = ( a20 * b05 - a22 * b02 + a23 * b01) * inv_det;
    r.m[2][0] = ( a10 * b10 - a11 * b08 + a13 * b06) * inv_det;
    r.m[2][1] = (-a00 * b10 + a01 * b08 - a03 * b06) * inv_det;
    r.m[2][2] = ( a30 * b04 - a31 * b02 + a33 * b00) * inv_det;
    r.m[2][3] = (-a20 * b04 + a21 * b02 - a23 * b00) * inv_det;
    r.m[3][0] = (-a10 * b09 + a11 * b07 - a12 * b06) * inv_det;
    r.m[3][1] = ( a00 * b09 - a01 * b07 + a02 * b06) * inv_det;
    r.m[3][2] = (-a30 * b03 + a31 * b01 - a32 * b00) * inv_det;
    r.m[3][3] = ( a20 * b03 - a21 * b01 + a22 * b00) * inv_det;
    return r;
}
