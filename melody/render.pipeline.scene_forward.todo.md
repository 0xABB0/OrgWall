...
- `scene_forward` now consumes scene-owned ambient, sky, ground, directional, and point lights through explicit buffers. Keep growing light/environment support without turning this module into the canonical home of scene lighting truth.
