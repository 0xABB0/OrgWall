...
- The scene now owns ambient, sky, ground, exposure, directional lights, and point lights. Grow that toward richer probes/environment/shadow inputs without letting one technique's cache layout become scene truth.
