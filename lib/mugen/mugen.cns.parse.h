...
static inline f32 mcns_eval_or_default(Mugen_Expr* e, Mugen_Char_State* st, f32 def) { return e ? mugen_expr_eval(e, st) : def; }

static inline u8 mcns_parse_animtype(str8 s)
{
    s = mcns_trim(s);
    if (str8_ieq_cstr(s, "light"))
        return MUGEN_ANIMTYPE_LIGHT;
    if (str8_ieq_cstr(s, "medium"))
        return MUGEN_ANIMTYPE_MEDIUM;
    if (str8_ieq_cstr(s, "hard"))
        return MUGEN_ANIMTYPE_HARD;
    if (str8_ieq_cstr(s, "back"))
        return MUGEN_ANIMTYPE_BACK;
    if (str8_ieq_cstr(s, "up"))
        return MUGEN_ANIMTYPE_UP;
    if (str8_ieq_cstr(s, "diagup"))
        return MUGEN_ANIMTYPE_DIAGUP;
    return MUGEN_ANIMTYPE_LIGHT;
}
...
{
    s = mcns_trim(s);
    if (str8_ieq_cstr(s, "high"))
        return MUGEN_GROUNDTYPE_HIGH;
    if (str8_ieq_cstr(s, "low"))
        return MUGEN_GROUNDTYPE_LOW;
    if (str8_ieq_cstr(s, "trip"))
        return MUGEN_GROUNDTYPE_TRIP;
    return MUGEN_GROUNDTYPE_HIGH;
}
