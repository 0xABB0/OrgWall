...
- **docs/platform-display.md, docs/platform-surface.md, docs/platform-sensors.md** — upstream. The `hdr` cap surface negotiates against the platform's color-space grant; thermal and power signals reach reconstruction through `Frame_Info`.
