...
#define str8_to_cstr(s, allocator)    _Generic((allocator), Mel_Arena*: str8_to_cstr_arena, const Mel_Alloc*: str8_to_cstr_alloc)(s, allocator)

#define str8_fmt(allocator, fmt, ...) _Generic((allocator), Mel_Arena*: str8_fmt_arena, const Mel_Alloc*: str8_fmt_alloc)(allocator, fmt, ##__VA_ARGS__)
