...
void mel_notation_set_enharmonic(Mel_Notation* n, Mel_EnharmonicStrategy strategy) { n->enharmonic = strategy; }
...
Mel_NoteScale mel_notation_scale(const Mel_Notation* n, Mel_Note* notes, int32_t count) { return mel_note_scale_make(n, notes, count); }

Mel_NoteIntervalSeq mel_notation_interval_seq(const Mel_Notation* n, Mel_NoteInterval* intervals, int32_t count) { return mel_note_interval_seq_make(n, intervals, count); }
