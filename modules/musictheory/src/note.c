...
Mel_Pitch mel_note_pitch(Mel_Note n) { return mel_pitch_copy(n.pitch); }

int32_t mel_note_bi_index(Mel_Note n) { return n.nat_bi_index; }
...
uint8_t mel_note_eq(Mel_Note a, Mel_Note b)
{
    ...
    if (!a.symbol || !b.symbol)
        return mel_pitch_eq(a.pitch, b.pitch);
