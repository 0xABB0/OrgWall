...
static mpfr_prec_t mel_interval_precision(void) { return MEL_INTERVAL_PRECISION; }
...
int64_t mel_interval_abs_diff(Mel_Interval i) { return i.pitch_diff >= 0 ? i.pitch_diff : -i.pitch_diff; }
...
void mel_interval_cents(mpfr_ptr out, Mel_Interval i) { mel_cent_from_ratio(out, i.ratio); }

uint8_t mel_interval_eq(Mel_Interval a, Mel_Interval b) { return mpfr_equal_p(a.ratio, b.ratio) ? 1 : 0; }
