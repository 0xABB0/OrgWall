...
static Mel_Mat3 mel__cat_bradford(void) {
    return mel__mat3_rows(0.8951f, 0.2664f, -0.1614f, -0.7502f, 1.7135f, 0.0367f, 0.0389f,
                          -0.0685f, 1.0296f);
}

static Mel_Mat3 mel__cat_cat02(void) {
    return mel__mat3_rows(0.7328f, 0.4296f, -0.1624f, -0.7036f, 1.6975f, 0.0061f, 0.0030f,
                          0.0136f, 0.9834f);
}

static Mel_Mat3 mel__cat_von_kries(void) {
    return mel__mat3_rows(0.40024f, 0.70760f, -0.08081f, -0.22630f, 1.16532f, 0.04570f, 0.0f,
                          0.0f, 0.91822f);
}
