...
float mel_delta_e_2000(mel_lab lab1, mel_lab lab2)
{
    ...
    double t = 1.0 - 0.17 * cos((hbarp - 30.0) * rad) + 0.24 * cos((2.0 * hbarp) * rad) + 0.32 * cos((3.0 * hbarp + 6.0) * rad) - 0.20 * cos((4.0 * hbarp - 63.0) * rad);
    ...
    double sl = 1.0 + (0.015 * (lbarp - 50.0) * (lbarp - 50.0)) / sqrt(20.0 + (lbarp - 50.0) * (lbarp - 50.0));
