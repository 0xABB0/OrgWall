...
mel_luv mel_color_to_luv(mel_color c) { return mel_xyz_to_luv(mel_color_to_xyz(c), mel_white_point_xyz(mel_white_d65())); }

mel_color mel_color_from_luv(mel_luv c, float a) { return mel_color_from_xyz(mel_luv_to_xyz(c, mel_white_point_xyz(mel_white_d65())), a); }
