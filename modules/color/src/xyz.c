...
mel_xyz mel_xyz_make(float x, float y, float z) { return (mel_xyz){ x, y, z }; }

mel_xyz mel_color_to_xyz(mel_color c)
{
    Mel_Mat3 m = mel__mat3_rows(0.4124564f, 0.3575761f, 0.1804375f, 0.2126729f, 0.7151522f, 0.0721750f, 0.0193339f, 0.1191920f, 0.9503041f);
...
{
    Mel_Mat3 m = mel__mat3_rows(3.2404542f, -1.5371385f, -0.4985314f, -0.9692660f, 1.8760108f, 0.0415560f, 0.0556434f, -0.2040259f, 1.0572252f);
