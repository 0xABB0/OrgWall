...
mel_color mel_color_rgb(float r, float g, float b) { return (mel_color){ r, g, b, 1.0f }; }

mel_color mel_color_rgba(float r, float g, float b, float a) { return (mel_color){ r, g, b, a }; }

mel_color mel_color_gray(float v) { return (mel_color){ v, v, v, 1.0f }; }
...
mel_color mel_color_with_alpha(mel_color c, float a) { return (mel_color){ c.r, c.g, c.b, a }; }

mel_color mel_color_scale(mel_color c, float s) { return (mel_color){ c.r * s, c.g * s, c.b * s, c.a }; }

mel_color mel_color_clamp01(mel_color c) { return (mel_color){ mel__sat(c.r), mel__sat(c.g), mel__sat(c.b), mel__sat(c.a) }; }
...
float mel_color_luminance(mel_color c) { return 0.2126f * c.r + 0.7152f * c.g + 0.0722f * c.b; }
...
mel_color mel_color_darken(mel_color c, float amount) { return mel_color_lighten(c, -amount); }
...
mel_color mel_color_desaturate(mel_color c, float amount) { return mel_color_saturate(c, -amount); }
