...
void build(Mel_Build* b)
{
    ...
    mel_sources(lib, WHEN(.platforms = MEL_ON(MACOS) | MEL_ON(IOS) | MEL_ON(LINUX) | MEL_ON(ANDROID)), "posix/src/dylib_posix.c");
    mel_sources(lib, WHEN(.platforms = MEL_ON(WIN32)), "win32/src/dylib_win32.c");
    mel_sources(lib, WHEN(.platforms = MEL_ON(WASM)), "wasm/src/dylib_wasm.c");
