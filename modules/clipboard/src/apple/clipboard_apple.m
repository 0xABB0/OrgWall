...
u64 mel_clip__plat_sequence(void) { return (u64)[NSPasteboard generalPasteboard].changeCount; }
...
u64 mel_clip__plat_sequence(void) { return (u64)[UIPasteboard generalPasteboard].changeCount; }
