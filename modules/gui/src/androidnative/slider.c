...
Mel_Gui_Handle mel_slider_create_opt(Mel_Gui_Handle parent, Mel_Slider_Opt o)
{
    ...
    {
        (*env)->CallStaticVoidMethod(env, s_cls, s_installChange, view, mel_gui__android_pack(h), (jlong)(intptr_t)o.on_.on_value_changed);
    }
...
JNIEXPORT void JNICALL Java_orgwall_melody_platform_MelSlider_nativeChange(JNIEnv* env, jclass cls, jlong h, jlong fn, jint value)
{
    (void)env;
    (void)cls;
    if (!fn)
