...
void mel_painter_draw_text(Mel_Painter* p, str8 text, Mel_Vec2 pos, Mel_Color k, f32 size)
{
    ...
    @autoreleasepool
    {
        ...
        NSColor*  color = [NSColor colorWithSRGBRed:k.r / 255.0 green:k.g / 255.0 blue:k.b / 255.0 alpha:k.a / 255.0];
        [s drawAtPoint:NSMakePoint(pos.x, pos.y) withAttributes:@{ NSFontAttributeName : font, NSForegroundColorAttributeName : color }];
    }
}
