...
bool mel_sem_init(Mel_Sem* s, u32 initial) { return sem_init(MEL__SEM(s), 0, initial) == 0; }

void mel_sem_destroy(Mel_Sem* s) { sem_destroy(MEL__SEM(s)); }
...
void mel_sem_post(Mel_Sem* s) { sem_post(MEL__SEM(s)); }
