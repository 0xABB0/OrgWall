...
void mel_tls_destroy(Mel_Tls* k) { TlsFree(MEL__TLS(k)); }

void* mel_tls_get(Mel_Tls* k) { return TlsGetValue(MEL__TLS(k)); }

void mel_tls_set(Mel_Tls* k, void* value) { TlsSetValue(MEL__TLS(k), value); }
