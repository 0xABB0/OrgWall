...
void mel_mutex_destroy(Mel_Mutex* m) { pthread_mutex_destroy(MEL__MUTEX(m)); }

void mel_mutex_lock(Mel_Mutex* m) { pthread_mutex_lock(MEL__MUTEX(m)); }

bool mel_mutex_trylock(Mel_Mutex* m) { return pthread_mutex_trylock(MEL__MUTEX(m)) == 0; }

void mel_mutex_unlock(Mel_Mutex* m) { pthread_mutex_unlock(MEL__MUTEX(m)); }
