...
{
    Mel_Target* lib = mel_add_library(b, "audioin");
    mel_includes(lib, MEL_PUBLIC, ALWAYS, "include");
    mel_sources(lib, ALWAYS, "src/audioin.c");
    ...
    mel_link(lib, MEL_PUBLIC, WHEN(.platforms = MEL_ON(MACOS)), "-framework", "CoreAudio", "-framework", "AudioToolbox", "-framework", "CoreFoundation", "-framework", "AVFoundation", "-framework", "Foundation");
    ...
    Mel_Target* t = mel_add_test(b, "audioin-core");
    mel_includes(t, MEL_PUBLIC, ALWAYS, "include");
    mel_sources(t, ALWAYS, "src/audioin.c");
    mel_sources(t, ALWAYS, "src/descriptors.c");
    mel_sources(t, ALWAYS, "src/publish.c");
    mel_sources(t, ALWAYS, "test/test_audioin.c");
