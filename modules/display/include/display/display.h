...
typedef enum {
    MEL_COLOR_SPACE_SRGB = 0,
    MEL_COLOR_SPACE_DISPLAY_P3,
    MEL_COLOR_SPACE_REC_709,
    MEL_COLOR_SPACE_REC_2020,
    MEL_COLOR_SPACE_SCRGB_LINEAR,
    MEL_COLOR_SPACE_HDR10_PQ,
    MEL_COLOR_SPACE_HLG,
    MEL_COLOR_SPACE_COUNT,
} Mel_Color_Space;
...
typedef enum {
    MEL_DISPLAY_CONNECTOR_UNKNOWN = 0,
    MEL_DISPLAY_CONNECTOR_INTERNAL,
    MEL_DISPLAY_CONNECTOR_HDMI,
    MEL_DISPLAY_CONNECTOR_DISPLAYPORT,
    MEL_DISPLAY_CONNECTOR_USB_C,
    MEL_DISPLAY_CONNECTOR_VGA,
    MEL_DISPLAY_CONNECTOR_VIRTUAL,
} Mel_Display_Connector;

typedef enum {
    MEL_DISPLAY_STATE_ACTIVE = 0,
    MEL_DISPLAY_STATE_MIRRORED,
    MEL_DISPLAY_STATE_DISCONNECTED,
    MEL_DISPLAY_STATE_POWERED_OFF,
    MEL_DISPLAY_STATE_DIMMED,
    MEL_DISPLAY_STATE_IDLE,
} Mel_Display_State;

typedef enum {
    MEL_DISPLAY_MASTERING_NONE = 0,
    MEL_DISPLAY_MASTERING_STATIC,
    MEL_DISPLAY_MASTERING_DYNAMIC,
} Mel_Display_Mastering;

typedef enum {
    MEL_DISPLAY_TONEMAP_DISPLAY = 0,
    MEL_DISPLAY_TONEMAP_COMPOSITOR,
    MEL_DISPLAY_TONEMAP_APPLICATION,
} Mel_Display_Tonemap;

typedef enum {
    MEL_DISPLAY_NATIVE_NONE = 0,
    MEL_DISPLAY_NATIVE_NSSCREEN,
    MEL_DISPLAY_NATIVE_UISCREEN,
    MEL_DISPLAY_NATIVE_DXGI_OUTPUT6,
    MEL_DISPLAY_NATIVE_VK_DISPLAY_KHR,
    MEL_DISPLAY_NATIVE_ANDROID_DISPLAY,
    MEL_DISPLAY_NATIVE_WL_OUTPUT,
    MEL_DISPLAY_NATIVE_X11_OUTPUT,
    MEL_DISPLAY_NATIVE_LOST,
