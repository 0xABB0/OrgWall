...
void build(Mel_Build* b)
{
    ...
    mel_sources(lib, WHEN(.platforms = MEL_ON(MACOS) | MEL_ON(IOS)), "apple/src/port_backend.c");
    mel_sources(lib, WHEN(.platforms = MEL_ON(LINUX) | MEL_ON(ANDROID)), "posix/src/port_backend.c");
    mel_sources(lib, WHEN(.platforms = MEL_ON(WIN32)), "win32/src/port_backend.c");
    mel_sources(lib, WHEN(.platforms = MEL_ON(WASM)), "none/src/port_backend.c");
