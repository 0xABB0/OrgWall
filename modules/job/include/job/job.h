...
#define mel_job_run(data, fn, counter, ...) mel_job_run_opt_debug((data), (fn), #fn, __FILE__, __LINE__, (counter), (Mel_Job_Run_Opt){ .worker = 0xFF, __VA_ARGS__ })
...
#define mel_job_run_n(data, fn, counter, n) mel_job_run_n_debug((data), (fn), #fn, __FILE__, __LINE__, (counter), (n))
