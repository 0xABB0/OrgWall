...
void build(Mel_Build* b)
{
    ...
    mel_sources(lib, WHEN(.platforms = MEL_ON(MACOS)), "macos/src/*.c", "apple/src/*.c", "apple/src/*.m");
    mel_sources(lib, WHEN(.platforms = MEL_ON(IOS)), "ios/src/*.c", "apple/src/*.c", "apple/src/*.m");
