...
void                      mel_server_reply          (Mel_Server_Req* req, i32 status, const char* headers, const char* fmt, ...) __attribute__((format(printf, 4, 5)));
void                      mel_server_reply_text     (Mel_Server_Req* req, i32 status, str8 body);
void                      mel_server_reply_json     (Mel_Server_Req* req, i32 status, const char* fmt, ...) __attribute__((format(printf, 3, 4)));
...
void                      mel_server_stream_printf  (Mel_Server_Req* req, const char* fmt, ...) __attribute__((format(printf, 2, 3)));
