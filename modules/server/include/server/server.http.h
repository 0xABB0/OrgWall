...
#define mel_server_route_add(s, out, ...) mel_server_route_add_opt((s), (Mel_Server_Route_Opt){ __VA_ARGS__ }, (out))
...
#define mel_server_serve_dir(s, out, ...) mel_server_serve_dir_opt((s), (Mel_Server_Serve_Dir_Opt){ __VA_ARGS__ }, (out))
...
#define mel_server_serve_file(s, out, ...) mel_server_serve_file_opt((s), (Mel_Server_Serve_File_Opt){ __VA_ARGS__ }, (out))
