...
#define mel_server_create(out, ...) mel_server_create_opt((Mel_Server_Opt){ __VA_ARGS__ }, (out))
...
#define mel_server_listen(s, out, ...) mel_server_listen_opt((s), (Mel_Server_Listen_Opt){ __VA_ARGS__ }, (out))
