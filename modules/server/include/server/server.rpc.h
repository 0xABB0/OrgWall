...
#define mel_server_rpc_mount(s, ...) mel_server_rpc_mount_opt((s), (Mel_Server_RPC_Mount_Opt){ __VA_ARGS__ })
...
#define mel_server_rpc_add(s, out, ...) mel_server_rpc_add_opt((s), (Mel_Server_RPC_Opt){ __VA_ARGS__ }, (out))
