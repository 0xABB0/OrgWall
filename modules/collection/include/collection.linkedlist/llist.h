...
#define mel_llist_init(ll, alloc)  \
    do                             \
    {                              \
        (ll)->head = nullptr;      \
        (ll)->tail = nullptr;      \
...
#define mel_llist_free(ll)   \
    do                       \
    {                        \
        mel_llist_clear(ll); \
    } while (0)

#define mel_llist_push_front(ll, item)                                                  \
    do                                                                                  \
    {                                                                                   \
...
#define mel_llist_push_back(ll, item)                                                   \
    do                                                                                  \
    {                                                                                   \
        typeof((ll)->head) mel__node = mel_alloc((ll)->allocator, sizeof(*(ll)->head)); \
        mel__node->value = (item);                                                      \
...
#define mel_llist_foreach(ll, varname, body)                     \
    do                                                           \
    {                                                            \
...
#define mel_llist_remove_node(ll, node_ptr)                         \
    do                                                              \
    {                                                               \
