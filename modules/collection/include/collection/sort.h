...
#define mel_sort_is_sorted(arr, count, lt_expr)            mel__sort_is_sorted_impl(arr, count, lt_expr, __COUNTER__)

#define mel__sort_is_sorted_impl(arr, count, lt_expr, uid) mel__sort_is_sorted_expand(arr, count, lt_expr, uid)
...
#define mel__sort_med3(arr, i, j, k, lt_expr, out)               \
    ...
    {                                                            \
        ...
        {                                                        \
            __auto_type a = (arr)[mel__m3_a];                    \
            __auto_type b = (arr)[mel__m3_b];                    \
            mel__m3_ab = (lt_expr);                              \
        }                                                        \
        {                                                        \
            __auto_type a = (arr)[mel__m3_b];                    \
            __auto_type b = (arr)[mel__m3_c];                    \
            mel__m3_bc = (lt_expr);                              \
        }                                                        \
        if (mel__m3_ab)                                          \
        {                                                        \
