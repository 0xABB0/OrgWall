...
#define mel_heap_push(h, item, lt_expr)                                                      \
    do                                                                                       \
    {                                                                                        \
...
#define mel__heap_pop_impl(h, lt_expr)                                 \
    __extension__({                                                    \
        ...
        {                                                              \
            ...
            {                                                          \
                ...
                {                                                      \
                    ...
                    typeof((h)->items[0]) b = (h)->items[mel__target]; \
                    if (lt_expr)                                       \
                        mel__target = mel__right;                      \
                }                                                      \
                if (mel__target == mel__i)                             \
                    break;                                             \
