...
#define mel_deque_init(dq, alloc)  \
    do                             \
    {                              \
        (dq)->items = NULL;        \
        (dq)->head = 0;            \
...
#define mel_deque_push_back(dq, item)                            \
    do                                                           \
    {                                                            \
...
#define mel_deque_push_front(dq, item)                                    \
    do                                                                    \
    {                                                                     \
        if ((dq)->count >= (dq)->capacity)                                \
        {                                                                 \
...
#define mel_deque_pop_front(dq)  ((dq)->count--, (dq)->head = ((dq)->head + 1) % (dq)->capacity, (dq)->items[((dq)->head == 0 ? (dq)->capacity : (dq)->head) - 1])

#define mel_deque_pop_back(dq)   ((dq)->count--, (dq)->items[((dq)->head + (dq)->count) % (dq)->capacity])
