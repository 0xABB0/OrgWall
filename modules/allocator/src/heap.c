...
static uintptr_t mel__heap_align_up_uintptr(uintptr_t value, usize align) { return (value + align - 1u) & ~((uintptr_t)align - 1u); }
...
static void* mel__heap_aligned_alloc(usize size, u32 align, const char* file, const char* func, u32 line)
{
...
static void* mel__heap_aligned_realloc(void* ptr, usize size, u32 align, const char* file, const char* func, u32 line)
{
...
static void* heap_alloc_cb(void* ptr, usize size, u32 align, const char* file, const char* func, u32 line, void* user_data)
{
...
static const Mel_Alloc s_heap_alloc = { .alloc_cb = heap_alloc_cb, .user_data = NULL };
...
static Mel_Guard_Allocator_Opt mel__heap_guard_opt(void)
{
    ...
    return (Mel_Guard_Allocator_Opt){
        ...
        .flags = MEL_GUARD_FLAG_CANARY_HEAD | MEL_GUARD_FLAG_CANARY_TAIL | MEL_GUARD_FLAG_POISON_ALLOC | MEL_GUARD_FLAG_POISON_FREE | MEL_GUARD_FLAG_QUARANTINE | MEL_GUARD_FLAG_CHECK_FREE,
    };
...
{
    u32 expected = 0;
    if (atomic_compare_exchange_strong_explicit(&s_heap_guard.init_state, &expected, 1, memory_order_acq_rel, memory_order_acquire))
    {
...
u32 mel_alloc_heap_memory_debug_level(void) { return (u32)MEL_MEMORY_DEBUG; }
