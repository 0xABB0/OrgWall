...
typedef f32 f32x4 MEL_VECTOR_TYPE(4);
...
MEL_NODISCARD static inline Mel_Vec4 mel_vec4_sub(Mel_Vec4 a, Mel_Vec4 b);
MEL_NODISCARD static inline Mel_Vec4 mel_vec4_mul(Mel_Vec4 a, Mel_Vec4 b);
...
MEL_NODISCARD static inline Mel_Vec4 mel_vec4_max(Mel_Vec4 a, Mel_Vec4 b);
MEL_NODISCARD static inline Mel_Vec4 mel_vec4_abs(Mel_Vec4 v);
MEL_NODISCARD static inline Mel_Vec4 mel_vec4_floor(Mel_Vec4 v);
MEL_NODISCARD static inline Mel_Vec4 mel_vec4_ceil(Mel_Vec4 v);
MEL_NODISCARD static inline Mel_Vec4 mel_vec4_round(Mel_Vec4 v);
MEL_NODISCARD static inline Mel_Vec4 mel_vec4_clamp(Mel_Vec4 v, Mel_Vec4 lo, Mel_Vec4 hi);
MEL_NODISCARD static inline Mel_Vec4 mel_vec4_saturate(Mel_Vec4 v);
