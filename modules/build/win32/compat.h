...
static inline void* dlsym(void* handle, const char* symbol) { return (void*)(uintptr_t)GetProcAddress((HMODULE)handle, symbol); }
...
static inline const char* dlerror(void)
{
    ...
    if (!err)
        return NULL;
    DWORD n = FormatMessageA(FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_IGNORE_INSERTS, NULL, err, 0, buf, sizeof(buf), NULL);
    if (n == 0)
