...
static HWND mel__checkbox_construct(Mel_Gui_Handle h, const Mel_Gui_Create_Desc* desc, HWND parent_hwnd)
{
    (void)h;
...
{
    mel_gui_win32_register_constructor(atom, mel__checkbox_construct);
}
