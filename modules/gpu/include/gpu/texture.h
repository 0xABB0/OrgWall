...
typedef enum
{
    ...
    MEL_GPU_TEXTURE_CREATE_BACKEND_FAILED = MEL_GPU_STATUS(2, MEL_GPU_SEVERITY_ERROR),
...
typedef enum
{
    ...
    MEL_GPU_TEXTURE_VIEW_CREATE_BACKEND_FAILED = MEL_GPU_STATUS(1, MEL_GPU_SEVERITY_ERROR),
