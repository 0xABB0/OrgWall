...
typedef enum
{
    ...
    MEL_GPU_QUERY_POOL_CREATE_BACKEND_FAILED = MEL_GPU_STATUS(3, MEL_GPU_SEVERITY_ERROR),
...
typedef enum
{
    ...
    MEL_GPU_QUERY_RESOLVE_BACKEND_FAILED = MEL_GPU_STATUS(2, MEL_GPU_SEVERITY_ERROR),
