...
{
    Mel_Target* lib = mel_add_library(b, "net");
    mel_includes(lib, MEL_PUBLIC, ALWAYS, "include");
    mel_sources(lib, ALWAYS, "src/net.c");
    mel_sources(lib, ALWAYS, "src/address.c");
    ...
    Mel_Target* t = mel_add_test(b, "net-core");
    mel_includes(t, MEL_PUBLIC, ALWAYS, "include");
    mel_sources(t, ALWAYS, "test/test_net.c");
