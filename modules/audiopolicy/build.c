...
{
    Mel_Target* lib = mel_add_library(b, "audiopolicy");
    mel_includes(lib, MEL_PUBLIC, ALWAYS, "include");
    mel_sources(lib, ALWAYS, "src/audiopolicy.c");
    mel_sources(lib, ALWAYS, "src/descriptors.c");

    mel_sources(lib, WHEN(.platforms = MEL_ON(MACOS)), "macos/src/*.c");
    mel_link(lib, MEL_PUBLIC, WHEN(.platforms = MEL_ON(MACOS)), "-framework", "CoreAudio", "-framework", "CoreFoundation");
    ...
    mel_link(lib, MEL_PUBLIC, WHEN(.platforms = MEL_ON(ANDROID)), "-llog");
    ...
    Mel_Target* t = mel_add_test(b, "audiopolicy-core");
    mel_includes(t, MEL_PUBLIC, ALWAYS, "include");
    mel_sources(t, ALWAYS, "src/audiopolicy.c");
    mel_sources(t, ALWAYS, "src/descriptors.c");
    mel_sources(t, ALWAYS, "test/test_audiopolicy.c");
