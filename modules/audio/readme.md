...
frames out of a module-owned lock-free SPSC float ring (`Mel_Audio_Ring`); the `thread`-spawned mix
...
rebound via `mel_audio_set_device`. OS interruptions hold and auto-resume through `audiopolicy`
