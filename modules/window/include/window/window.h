...
static inline bool mel_window_is_none(Mel_Window w) { return w.index == 0 && w.generation == 0; }

static inline bool mel_window_eq(Mel_Window a, Mel_Window b) { return a.index == b.index && a.generation == b.generation; }
