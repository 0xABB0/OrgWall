...
[[nodiscard]] static inline Mel_Mat4 mel_mat4_scalef(f32 s);
[[nodiscard]] static inline Mel_Mat4 mel_mat4_rotateXY(f32 ax, f32 ay);
[[nodiscard]] static inline Mel_Mat4 mel_mat4_rotateXYZ(f32 ax, f32 ay, f32 az);
[[nodiscard]] static inline Mel_Mat4 mel_mat4_rotateZYX(f32 ax, f32 ay, f32 az);
[[nodiscard]] static inline Mel_Vec3 mel_mat4_mul_vec3(Mel_Mat4 m, Mel_Vec3 v);
