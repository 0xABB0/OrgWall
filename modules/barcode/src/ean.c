...
bool mel_ean13_encode(mel_barcode_matrix* out, const char* digits, i32 height, const Mel_Alloc* allocator)
{
...
bool mel_ean8_encode(mel_barcode_matrix* out, const char* digits, i32 height, const Mel_Alloc* allocator)
{
    if (digits == NULL || height <= 0)
    {
        return false;
...
bool mel_upca_encode(mel_barcode_matrix* out, const char* digits, i32 height, const Mel_Alloc* allocator)
{
    if (digits == NULL || height <= 0)
    {
        return false;
