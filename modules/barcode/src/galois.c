...
static u16 mel__gfp_add(const mel_gf* f, u16 a, u16 b) {
    return (u16)(((u32)a + (u32)b) % f->order);
}

static u16 mel__gfp_sub(const mel_gf* f, u16 a, u16 b) {
    return (u16)(((u32)a + (u32)f->order - (u32)b) % f->order);
}

static u16 mel__gfp_mul(const mel_gf* f, u16 a, u16 b) {
    return (u16)(((u32)a * (u32)b) % f->order);
}

bool mel_gf_binary_init(mel_gf* f, u16 order, u16 primitive_poly,
