...
static const V3 CORNERS[8] = {
    { -0.9f, -0.9f, -0.9f }, { 0.9f, -0.9f, -0.9f }, { 0.9f, 0.9f, -0.9f }, { -0.9f, 0.9f, -0.9f }, { -0.9f, -0.9f, 0.9f }, { 0.9f, -0.9f, 0.9f }, { 0.9f, 0.9f, 0.9f }, { -0.9f, 0.9f, 0.9f },
};
...
static void cube_render(void* state, Mel_Gpu_Command_List* cmd, f64 dt)
{
    ...
    for (i32 face = 0; face < 6; ++face)
    {
        ...
        for (i32 t = 0; t < 2; ++t)
        {
            ...
            V3 center = { (a.x + b.x + d.x) / 3.0f, (a.y + b.y + d.y) / 3.0f, (a.z + b.z + d.z) / 3.0f };
            ...
            for (i32 k = 0; k < 3; ++k)
            {
                ...
                out[count++] = (Pt_Vertex){ { ndc_x, ndc_y, 0.5f }, { base.x * shade, base.y * shade, base.z * shade, 1.0f } };
            }
        }
    }
